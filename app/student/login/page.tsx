      ...
      <form onSubmit={handleLogin} className="space-y-5">
        ...
        <label className="block text-sm font-semibold">
          ...
          <div className="relative">
            ...
            <input className={`${inputClass} pl-11`} type="email" autoComplete="email" required value={email} onInput={() => setError('')} onChange={(e) => { setEmail(e.target.value); setError(''); }} />
          </div>
        </label>
        ...
        <label className="block text-sm font-semibold">
          ...
          <div className="relative">
            ...
            <input className={`${inputClass} pr-11 pl-11`} type={showPassword ? 'text' : 'password'} autoComplete="current-password" required value={password} onInput={() => setError('')} onChange={(e) => { setPassword(e.target.value); setError(''); }} />
