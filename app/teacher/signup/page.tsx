...
export default function TeacherSignupPage() {
  ...
  return (
    <AuthShell title="Create Teacher Account" subtitle="Manage your classroom and help students learn.">
      <form onSubmit={submit} className="space-y-5">
        ...
        <label className="block text-sm font-semibold">
          School Name
          <input className={inputClass} required value={schoolName} onChange={(e) => setSchoolName(e.target.value)} />
        </label>
        ...
        <p className="text-center text-sm text-muted-foreground">
          Already have an account? <Link href="/teacher/login" className="font-semibold text-primary hover:underline">Sign in</Link>
        </p>
      </form>
    </AuthShell>
  )
